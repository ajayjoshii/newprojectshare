...
//   return (
//     <div className="relative min-h-screen mt-[65px]">
//       {/* Location Badge on top-right fixed corner */}
//       {province && (
//         <div className="fixed top-5 right-52 bg-green-600 text-white px-4 py-2 rounded shadow-lg z-50 font-semibold">
//           Province: {province}
//         </div>
//       )}
...
// export default function Home({ addToCart, province, setProvince, provinces, recs, defaultFoodItems }) {
//   return (
//     <div className="relative min-h-screen mt-[65px]">
//       {/* Location Badge on top-right fixed corner */}
//       {province && (
...
//       {/* Food Items Grid */}
//       <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
//         {/* If there are recommendations and some in filtered recs, show them */}
//         {recs.length > 0 ? (
//           recs.map((item) => <FoodItem key={item.id} item={item} addToCart={addToCart} />)
//         ) : province && provinces.includes(province) ? (
//           <p className="text-gray-600">No recommendations found for your province.</p>
//         ) : (
//           // Show default food items if no recs or no province selected
//           defaultFoodItems.map((item) => (
//             <FoodItem key={item.id} item={item} addToCart={addToCart} />
//           ))
//         )}

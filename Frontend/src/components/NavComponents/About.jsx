...
const About = () => {
  return (
    <div className="max-w-4xl mx-1 p-6 text-gray-800 mt-[90px]">

      <section className="mb-8">
        <h1 className="text-4xl font-extrabold mb-3">About Us</h1>
        <p className="mb-4 text-2xl w-6xl">
        ...
        <p className="mb-4 text-xl w-6xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 gap-x-100 mb-12">
        <section className="p-6 bg-white rounded-md shadow-md w-[550px] h-[300px] ">
          <h3 className="text-3xl font-semibold mb-4">FoodOrderNP Pvt. Ltd.</h3>
          <ul className="list list-inside space-y-3 text-lg">
        ...
        <section className="p-6 bg-white rounded-md shadow-md w-[550px]">
          <h3 className="text-3xl font-semibold mb-4">Office Locations</h3>
          <ul className="list list-inside space-y-3 text-lg">
        ...
        <section className="p-6 bg-white rounded-md shadow-md w-[550px] h-[300px]">
          ...
          <p className="text-lg mb-3"><strong>Email:</strong> <a href="mailto:info@foodmandu.com" className="text-blue-600 hover:underline">info@FoodOrderNP.com</a></p>
        ...
        <section className="p-6 bg-white rounded-md shadow-md w-[550px]">
          ...
          <p className="text-lg mb-3"><strong>Contact Person/Unit:</strong> Customer Care Department</p>
          <p className="text-lg mb-3"><strong>Email:</strong> <a href="mailto:support@foodmandu.com" className="text-blue-600 hover:underline">support@FoodOrderNP.com</a></p>
          <p className="text-lg"><strong>Telephone:</strong> 9815898401, 9803301192</p>
        </section>
      </div>

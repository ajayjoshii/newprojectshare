export default function Contact() {
  return (
    <div className="mt-[100px] ">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 gap-x-40 mb-12">
        <section className="p-6 bg-white rounded-md shadow-md w-[760px] h-[300px]">
        ...
        <section className="p-6 bg-white rounded-md shadow-md w-[750px]">

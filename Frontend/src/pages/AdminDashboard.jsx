...
//             <button onClick={() => setActiveTab("users")} className={`px-3 py-1 rounded ${activeTab === "users" ? "bg-green-600 text-white" : "text-white hover:bg-blue-400 duration-750 font-bold"}`}>Users</button>
//             <button onClick={() => setActiveTab("items")} className={`px-3 py-1 rounded ${activeTab === "items" ? "bg-green-600 text-white" : "text-white hover:bg-blue-400 duration-750"}`}>Items</button>

//             <button onClick={() => setActiveTab("orders")} className={`px-3 py-1 rounded ${activeTab === "orders" ? "bg-green-600 text-white" : "text-white hover:bg-blue-400 duration-750"}`}>Orders</button>

//             <button onClick={() => setActiveTab("payments")} className={`px-3 py-1 rounded ${activeTab === "payments" ? "bg-green-600 text-white" : "text-white hover:bg-blue-400 duration-750"}`}>Payments</button>
//           </div>
//         </nav>
